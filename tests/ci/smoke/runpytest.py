...
run = Run.get_context()
print('before subprocess.run tests/smoke')
...
subprocess.run(["pytest","tests/smoke/test_notebooks_python.py::test_sar_single_node_smoke","-m","notebooks and not spark and gpu", "--junitxml=reports/test-unit.xml"])
